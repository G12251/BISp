// const { axiosInstance } = require("./index.jsx");
...
export const GetAllMovies = async () => {
    try {
        const response = await axiosInstance.get("http://localhost:5000/api/movies/get-all-movies");
        return response.data;
    } catch (error) {
        return error.response;
    }
...
export const GetMovieById = async (id) => {
    try {
        const response = await axiosInstance.get(`http://localhost:5000/api/movies/get-movie-by-id/${id}`);
        return response.data;
    } catch (error) {
        return error.response;
    }
